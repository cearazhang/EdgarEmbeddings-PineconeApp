...
st.markdown(" - In the Portfolio selection page, you can choose a subset of the stocks you wish to include in your portfolio.")
st.markdown(" - In the Portfolio Optimization page, you can choose the constraints under which you wish to optimize.")
